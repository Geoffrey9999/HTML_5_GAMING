...
function init() {
    ...
    // game.state.destroy();
    // game.state.kill('level1');
    // delete block.canvas;

    // game.state.clearCurrentState();
    // game.state.restart();
    // game.state.start("boss1", true, true);
    // game = new Phaser.stage(800, 450, Phaser.CANVAS, 'Mario2', { preload: preload, create: create, update: update, render: render });
}
